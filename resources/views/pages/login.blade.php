                    ...
                    <div
                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="intro-x mt-8">
                                <x-base.form-input name="email"
                                    class="intro-x block min-w-full px-4 py-3 xl:min-w-[350px]" type="email" required
                                    placeholder="Email" />
                                <x-base.form-input name="password" required
                                    class="intro-x mt-4 block min-w-full px-4 py-3 xl:min-w-[350px]" type="password"
                                    placeholder="Password" />
                            </div>
                            <div class="intro-x mt-4 flex text-xs text-slate-600 dark:text-slate-500 sm:text-sm">
                                <div class="mr-auto flex items-center">
                                    <x-base.form-check.input class="mr-2 border" name="remember-me" id="remember-me"
                                        type="checkbox" />
