                    ...
                    <div class="flex-auto block p-3">
                        <div class="overflow-x-auto lg:overflow-visible">
                            <div class="bg-white rounded-3xl p-8 mb-5">
                                <h1 class="text-3xl font-bold mb-10">Messaging ID framework development for the
                                    marketing branch</h1>
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <div class="col-span-2">
                                                <div class="p-4 bg-purple-100 rounded-xl text-gray-800">
                                                    <div class="font-bold text-xl leading-none">Your daily plan
                                                    </div>
                                        ...
                                        <div class="space-y-4">
                                            <div class="p-4 bg-white border rounded-xl text-gray-800 space-y-2">
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="font-bold hover:text-yellow-800 hover:underline">Blog
                                                    and social posts</a>
